...
<head>
  ...
  <title>Eqson: Venta Articulos</title>
  
</head>
<body>
  <?php include 'vistas/cabeceraPagina.html'; ?>

  <!-- Barra de navegación dinámica aa. -->
  <nav>
    <div>
      <ul class="seccion">
      ...
      <form class="seccion" >
        <input type="search" name="q" placeholder="Encuentra tus Articulos" >
